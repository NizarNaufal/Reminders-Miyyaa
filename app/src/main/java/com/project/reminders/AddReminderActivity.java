...
import com.project.reminders.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    // Values for orientatiton change
    ...
    private void deleteReminder() {
        ...
        if (mCurrentReminderUri != null) {
            ...
            if (rowsDeleted == 0) {
                ...
                Toast.makeText(this, "Error with deleting reminder",
                        Toast.LENGTH_SHORT).show();
            } else {
                // Otherwise, the delete was successful and we can display a toast
                Toast.makeText(this, "Reminder deleted",
                        Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void saveReminder() {
        ...
        if (mCurrentReminderUri == null) {
            ...
            if (newUri == null) {
                ...
                Toast.makeText(this, "Error with saving reminder",
                        Toast.LENGTH_SHORT).show();
            } else {
            ...
            if (rowsAffected == 0) {
                ...
                Toast.makeText(this, "Error with updating reminder",
                        Toast.LENGTH_SHORT).show();
            } else {
